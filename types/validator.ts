...
{
  type __IsExpected<Specific extends AppPageConfig<'/auth/forgot-password'>> =
    Specific
...
{
  type __IsExpected<Specific extends AppPageConfig<'/auth/sign-up-success'>> =
    Specific
...
{
  type __IsExpected<Specific extends AppPageConfig<'/auth/update-password'>> =
    Specific
...
{
  type __IsExpected<Specific extends RouteHandlerConfig<'/auth/confirm'>> =
    Specific
